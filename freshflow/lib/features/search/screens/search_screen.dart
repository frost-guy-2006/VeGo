...
class _SearchScreenState extends State<SearchScreen> {
  ...
  late final ProductRepository _productRepository =
      widget.productRepository ?? ProductRepository();
  Timer? _debounce;
  ...
  Future<void> _performSearch(String query) async {
    ...
    // Memory explicitly states visual mode triggers ONLY if query EXACTLY matches a color category name in colorKeywords.
    // E.g., 'Red', 'Blue', 'Green', 'Orange', 'Yellow'. Let's check keys of colorKeywords.
    final matchedColor = Product.colorKeywords.keys.firstWhere(
    ...
    try {
      ...
      // Clear results if user cleared search before network finished
