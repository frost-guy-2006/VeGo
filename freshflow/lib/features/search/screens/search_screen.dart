...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      // Ensure that the query hasn't changed since we started the request
      if (_searchController.text != query &&
          !(_activeColorFilter != null &&
              _searchController.text.toLowerCase() ==
                  _activeColorFilter!.toLowerCase())) {
        // This validation is a bit tricky because of capitalization logic.
        // Simplified: if controller text is completely different, discard.
        // But with debounce, we are usually fine.
        // Let's stick to simple debounce for now.
      }
