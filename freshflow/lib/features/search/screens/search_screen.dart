...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    // Check if the query matches a valid color directly
    final colorMatch = Product.colorKeywords.keys.cast<String?>().firstWhere(
