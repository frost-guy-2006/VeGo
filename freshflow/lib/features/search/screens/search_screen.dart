...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (widget.initialQuery != null) {
      ...
      // Use addPostFrameCallback to ensure widget is mounted/ready if needed,
      // though _performSearch calls setState so it should be fine here.
      // However, for consistency with Flutter lifecycle best practices:
  ...
  void _performSearch(String query) async {
    ...
    if (Product.colorKeywords.keys
        .any((k) => k.toLowerCase() == lowerQuery)) {
