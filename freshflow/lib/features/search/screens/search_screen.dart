...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    String? newColorFilter;
    if (['red', 'blue', 'green', 'orange', 'yellow'].contains(lowerQuery)) {
      // Capitalize first letter for display
      newColorFilter = lowerQuery[0].toUpperCase() + lowerQuery.substring(1);
    }
    ...
    try {
      ...
      if (newColorFilter != null) {
        ...
        results =
            await _productRepository.searchProductsByColor(newColorFilter);
      } else {
      ...
      if (mounted) {
        setState(() {
          _activeColorFilter = newColorFilter;
