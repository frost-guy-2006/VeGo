...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    // Check if the query is an exact match for one of the colors
    String? matchedColor;
    for (final color in Product.colorKeywords.keys) {
      if (color.toLowerCase() == trimmedQuery.toLowerCase()) {
        matchedColor = color;
        break;
      }
    }
