...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    // Use the colorKeywords map from Product to check for visual search
    final matchingColor = Product.colorKeywords.keys.firstWhere(
      (color) => color.toLowerCase() == lowerQuery,
      orElse: () => '',
    );
    ...
    try {
      ...
      // Ensure that if user cleared search while network request was pending, we don't show stale results
