...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    // Capitalize first letter to match keys in colorKeywords
    final capitalizedQuery = lowerQuery.isEmpty
        ? ''
    ...
    try {
      ...
      // Ensure that if the user cleared the search while we were fetching, we don't show stale results
