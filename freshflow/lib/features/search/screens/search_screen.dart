...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (widget.initialQuery != null) {
      ...
      // Use addPostFrameCallback to ensure widget is mounted before search
  ...
  void _performSearch(String query) async {
    ...
    // Preserve legacy behavior for colors not in map but previously supported in UI
    if (matchedColor == null &&
        ['blue', 'yellow'].contains(lowerQuery)) {
      matchedColor =
    ...
    try {
      ...
      if (!mounted) return;
      // Discard results if query has changed
