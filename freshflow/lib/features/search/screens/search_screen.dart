  ...
  void _performSearch(String query) async {
    ...
    try {
      ...
      if (_activeColorFilter != null) {
        // Server-side filtering by inferred color keywords
        filtered = await _productRepository
            .searchProductsByColor(_activeColorFilter!);

        // Client-side fallback filter to match exact inference logic if needed
        filtered = filtered
      ...
      if (_searchController.text.toLowerCase() != lowerQuery) return;
