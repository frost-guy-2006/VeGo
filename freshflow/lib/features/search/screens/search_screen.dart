...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      if (_activeColorFilter != null) {
        // Filter by inferred color using server side filter
        filtered = await _productRepository.searchProductsByColor(lowerQuery);
      } else {
        // Filter by name using server side filter
  ...
  Widget build(BuildContext context) {
    ...
    if (_activeColorFilter == 'Yellow') themeColor = Colors.yellow;
