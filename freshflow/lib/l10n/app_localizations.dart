...
abstract class AppLocalizations {
  ...
  /// Title shown on home page product section
  ///
  /// In en, this message translates to:
  /// **'Fresh Harvest'**
  String get homePageTitle;

  /// Hint text in search bar
  ///
  /// In en, this message translates to:
  ...
  /// Prompt to add delivery address
  ///
  /// In en, this message translates to:
  /// **'Add Address'**
  ...
  /// End of product list message
  ///
  /// In en, this message translates to:
  /// **'You\'ve seen all products! 🎉'**
  String get endOfList;

  /// Snackbar when item is added to cart
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @teaCoffee.
  ///
  /// In en, this message translates to:
  /// **'Tea/Coffee'**
  String get teaCoffee;
  ...
  /// Smart swap success message
  ///
  /// In en, this message translates to:
  /// **'Swapped! You saved ₹{amount}.'**
