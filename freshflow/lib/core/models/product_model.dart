class Product {
  ...
  static const Map<String, List<String>> colorKeywords = {
    'Red': ['red', 'tomato', 'apple', 'strawberry', 'cherry'],
    'Green': ['green', 'spinach', 'broccoli', 'cucumber', 'lettuce', 'cabbage'],
    'Orange': ['orange', 'carrot', 'banana', 'pumpkin'],
    'Yellow': ['yellow', 'lemon', 'corn'],
    'Blue': ['blue', 'blueberry'],
  };
