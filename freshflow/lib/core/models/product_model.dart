class Product {
  ...
  // Static color mapping for both client-side inference and server-side search
  static const Map<String, List<String>> colorKeywords = {
    ...
    'Blue': [], // Placeholder for demo
    'Yellow': [], // Placeholder for demo
  };
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    // Mock Visual Search Tagging logic using static map
