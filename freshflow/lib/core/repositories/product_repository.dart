...
class ProductRepository {
  ...
  Future<List<Product>> searchProductsByColor(String color) async {
    ...
    // Map colors to matching keywords in our dataset
    if (lowerColor == 'red') {
      orQuery =
      ...
      orQuery =
          'name.ilike.%yellow%,name.ilike.%banana%,name.ilike.%lemon%,name.ilike.%mango%';
    } else {
      // Fallback if color doesn't have specific mappings
