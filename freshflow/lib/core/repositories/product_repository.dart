...
class ProductRepository {
  ...
  /// Search products by color utilizing colorKeywords from Product model
  Future<List<Product>> searchProductsByColor(String color) async {
    final keywords = Product.colorKeywords[color];

    // Fallback to standard search if color is not in our known list
    if (keywords == null || keywords.isEmpty) {
      return searchProducts(color);
    }

    // Build an OR filter like "name.ilike.%red%,name.ilike.%tomato%,..."
