...
class ProductRepository {
  ...
  /// Search products by color (inferred visually from name keywords)
  Future<List<Product>> searchProductsByColor(String color) async {
    final keywords = Product.colorKeywords[color];

    if (keywords == null || keywords.isEmpty) {
      // Fallback to regular search if color not recognized
      return searchProducts(color);
    }

    // Construct an .or() query like: 'name.ilike.%red%,name.ilike.%tomato%,...'
