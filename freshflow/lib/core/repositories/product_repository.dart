...
class ProductRepository {
  ...
  Future<List<Product>> searchProductsByColor(String color) async {
    ...
    if (lowerColor == 'red') {
      queryStr = 'name.ilike.%tomato%,name.ilike.%apple%,name.ilike.%strawberry%,name.ilike.%red%';
    } else if (lowerColor == 'green') {
      queryStr = 'name.ilike.%spinach%,name.ilike.%broccoli%,name.ilike.%cucumber%,name.ilike.%green%';
    } else if (lowerColor == 'orange') {
      queryStr = 'name.ilike.%carrot%,name.ilike.%banana%,name.ilike.%orange%';
    } else {
